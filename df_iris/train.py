...
def train(args: argparse.Namespace) -> None:
    ...
    stage_plan = (
        ...
        ("local", int(training.get("local_epochs", 20))),
        ("integrated", int(training.get("integrated_epochs", 20))),
        ("full", int(training.get("full_epochs", 40))),
    )
    ...
    arcface_start_epoch = int(training.get("arcface_start_epoch", 1))
